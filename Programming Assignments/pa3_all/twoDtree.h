...
public:
   ...
   * You may want a recursive helper function for this one.
   ...
   void pruneTree(Node * toPrune, double pct, int tol);
   void updateMT(double & validNodes, double & numberPixels, Node * toCheck, int tol, RGBAPixel avg);
   bool iswithinBoundary(RGBAPixel toMatch, int tol, RGBAPixel avg);
   void clear(Node * ruut);
   Node* copyNode(Node * toCopy);
   void renderNodes(PNG & pic, Node* curr);
