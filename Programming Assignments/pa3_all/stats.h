...
private:
	 ...
	 * useful in computing the score of a rectangle PA3 function
	 * @param channel is one of r, g, or b
	 * @param ul is (x,y) of the upper left corner of the rectangle
	 * @param lr is (x,y) of the lower right corner of the rectangle
	 */
...
public:
   ...
   * mean, over all color channels. Will be used to make split when
	 ...
	 * rectangle as a pixel. Each color component of the pixel is
	 * the average value of that component over the rectangle.
	 * @param ul is (x,y) of the upper left corner of the rectangle
	 * @param lr is (x,y) of the lower right corner of the rectangle
	 */
