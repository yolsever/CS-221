EXENAME = pa1
OBJS = main.o PNG.o HSLAPixel.o lodepng.o chain.o block.o PNGutil.o
...
PNGutil.o : PNGutil.cpp PNGutil.h cs221util/PNG.cpp cs221util/PNG.h cs221util/HSLAPixel.h cs221util/lodepng/lodepng.h
	$(CXX) $(CXXFLAGS) PNGutil.cpp
